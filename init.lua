...
--  and `:help 'listchars'`
vim.opt.list = true
-- before: vim.opt.listchars = { tab = '» ', trail = '·', nbsp = '␣' }
...
vim.api.nvim_set_keymap('n', '<leader>cd', '<cmd>cd %:p:h<cr><cmd>pwd<cr>', { desc = "Change CWD to current file's directory" })
-- [[ Basic Keymaps ]]
...
vim.keymap.set('n', '<leader>z', '<cmd>cd %:p:h<CR>', { desc = 'Set CWD to Current File directory' })

--  Barbar Buffer tabs keymaps
...
{ '<leader>t', group = '[T]oggle' },
  ...
  },
  {
    ...
    config = function()
      ...
      dashboard.section.buttons.val = {
        ...
        dashboard.button('s', '  > Settings', ':e $MYVIMRC | :cd %:p:h | 8split . | wincmd k | pwd<CR>'),
        ...
        gopls = {
          ...
          settings = {
            gopls = {
              ...
              usePlaceholders = true, -- Highly recommended for Go
              analyses = {
                unusedparams = true,
              },
            },
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters = {
        stylua = {
          command = 'stylua',
          args = { --NOTE: workaround but it should be a better way to make this work
  ...
  require 'custom.plugins.unimpaired',
